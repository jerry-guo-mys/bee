...
// 柔和深色背景（暖色调，减少视觉疲劳）
pub const APP_BG: Color = Color::Rgb(18, 20, 26);
pub const PANEL_BG: Color = Color::Rgb(28, 32, 42);
pub const PANEL_BG_SOFT: Color = Color::Rgb(38, 42, 56);
pub const PANEL_BORDER: Color = Color::Rgb(66, 78, 108);
pub const PANEL_BORDER_ACTIVE: Color = Color::Rgb(122, 174, 255);
...
pub const TEXT_SUBTLE: Color = Color::Rgb(106, 124, 148);
...
pub const DIVIDER: Color = Color::Rgb(48, 54, 79);
