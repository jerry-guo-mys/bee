...
- For current news, prefer the `news` tool. For exchange rates, prefer `exchange_rate`. For stock/index/crypto prices, prefer `market_quote`. For live sports scores, prefer `sports_score`.
...
- news: Get current news headlines. Args: {"query": "optional topic", "limit": 5}.
- exchange_rate: Get live exchange rates. Args: {"base": "USD", "quote": "CNY", "amount": 1}.
- market_quote: Get live stock, index, or crypto quotes. Args: {"symbols": ["AAPL", "BTC-USD"]}.
- sports_score: Get live sports scores. Args: {"league": "nba|nfl|mlb|nhl|epl", "team": "optional"}.
